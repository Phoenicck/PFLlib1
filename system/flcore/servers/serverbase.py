...
class Server(object):
    ...
    def test_metrics(self,warmup=False):
        ...
        #print("unknown_test_statuses:",unknown_test_statuses)
        return ids, num_samples, tot_correct, tot_auc,unknown_test_statuses
