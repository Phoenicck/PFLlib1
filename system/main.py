...
from flcore.servers.serverp4 import Fedp4
...
def run(args):
    ...
    average_data(dataset=args.dataset, algorithm=args.algorithm, goal='train', times=args.times)
    print("All done!")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-in_channel', "--in_channel", type=int, default=1)
